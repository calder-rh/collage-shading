...
class GlobalControls(Network):
    ...
    def __init__(self, _):
        ...
        if is_new:
            ...
            addAttr(gcn, p='atmospheric_perspective', ln='min_distance', min=0, smx=2000, dv=1000)
            ...
            lighting_controller_trans.atmospheric_perspective.color.set(0.119, 0.294, 0.358)
