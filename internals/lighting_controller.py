...
class LightingController(Network):
    ...
    def __init__(self, _):
        ...
        world_sun_pair = SunPair({'usage': 'world'}, light_direction_trans, make_objects=True)

        world_sun_pair.sun_position >> sc.suns.world_sun_position
        world_sun_pair.antisun_position >> sc.suns.world_antisun_position
